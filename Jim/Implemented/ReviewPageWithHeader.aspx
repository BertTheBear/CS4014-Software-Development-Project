...
<body>
	...
	<option value="88">PC</option>
            ...
            <div style="float: left; width: 190px; margin-left: 5px; text-align: right; border: 1px solid black">
                ...
                <div id="cphMain_comfortDiv" style="height: 25px">
                    Graphics:
                    <select name="ctl00$cphMain$ComfortDropList" id="cphMain_ComfortDropList">
	<option value=""></option>
	...
	<option value="5">5</option>
                ...
                <div id="cphMain_reliabilityDiv" style="height: 25px">
                    Gameplay:
                    <select name="ctl00$cphMain$ReliabilityDropList" id="cphMain_ReliabilityDropList">
	<option value=""></option>
	<option value="1">1</option>
	<option value="2">2</option>
	<option value="3">3</option>
	...
	<option value="5">5</option>
                ...
                <div id="cphMain_looksDiv" style="height: 25px">
                    Story:
                    <select name="ctl00$cphMain$LooksDropList" id="cphMain_LooksDropList">
	<option value=""></option>
	<option value="1">1</option>
	<option value="2">2</option>
	<option value="3">3</option>
	...
	<option value="5">5</option>
                ...
                <div id="cphMain_economyDiv" style="height: 25px">
                    Sounds:
                    <select name="ctl00$cphMain$EconomyDropList" id="cphMain_EconomyDropList">
	<option value=""></option>
	<option value="1">1</option>
	<option value="2">2</option>
	<option value="3">3</option>
	...
	<option value="5">5</option>
            ...
            <div id="cphMain_fileUploadDiv" style="height: 25px">
                Chose picture:

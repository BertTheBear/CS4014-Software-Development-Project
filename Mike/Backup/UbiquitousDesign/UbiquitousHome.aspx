...
<img src="ArticleImages/<%=getArticle(0,1)%>.jpg" alt="Article Image" height="140px" width="170px" /><!-- This gets the image associated with the article -->
                    </td>
            ...
            <table>
                ...
                <tr>
                    <td style="background-color:transparent; max-height:200px; max-width:175px; width:175px;" class="style1">
<img src="ArticleImages/<%=getArticle(1,1)%>.jpg" alt="Article Image" height="140px" width="170px" /><!-- This gets the image associated with the article -->
                    </td>
                    <td style="overflow: hidden; max-width: 280px; width: 280px; max-height:200px; text-align: justify; background-color:transparent;">
                     <i><%=getArticle(1,2)%></i>
                        <br /> <br />
            ...
            <table style="width: 460px; max-height:200px;">
                ...
                <tr>
                    <td style="background-color:transparent; max-height:200px; max-width:175px; width:175px;" class="style1">
<img src="ArticleImages/<%=getArticle(2,1)%>.jpg" alt="Article Image" height="140px" width="170px" /><!-- This gets the image associated with the article -->
                    </td>
                    <td style="overflow: hidden; max-width: 280px; width: 280px; max-height:200px; text-align: justify; background-color:transparent;">
                     <i><%=getArticle(2,2)%></i>
                        <br /> <br />
            ...
            <table style="width: 460px; max-height:200px;">
                ...
                <tr>
                    <td style="background-color:transparent; max-height:200px; max-width:175px; width:175px;" class="style1">
<img src="ArticleImages/<%=getArticle(3,1)%>.jpg" alt="Article Image" height="140px" width="170px" /><!-- This gets the image associated with the article -->
                    </td>
                    <td style="overflow: hidden; max-width: 280px; width: 280px; max-height:200px; text-align: justify; background-color:transparent;">
                     <i><%=getArticle(3,2)%></i>
                        <br /> <br />
            ...
            <table style="width: 460px; max-height:200px;">
                ...
                <tr>
                    <td style="background-color:transparent; max-height:200px; max-width:175px; width:175px;" class="style1">
<img src="ArticleImages/<%=getArticle(4,1)%>.jpg" alt="Article Image" height="140px" width="170px" /><!-- This gets the image associated with the article -->
                    </td>
                    <td style="overflow: hidden; max-width: 280px; width: 280px; max-height:200px; text-align: justify; background-color:transparent;">
                     <i><%=getArticle(4,2)%></i>
                        <br /> <br />
